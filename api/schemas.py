...
class ModuleResult(BaseModel):
    ...
    flag_pct: float
    duration_s: float
    status: JobStatus             = JobStatus.COMPLETED   # ← reuses JobStatus


class JobResponse(BaseModel):
    job_id: str
    status: JobStatus                                      # ← already correct
    progress: int
    message: str
    created_at: datetime                                   # ← datetime not str
    updated_at: datetime                                   # ← datetime not str
...
class HealthResponse(BaseModel):
    ...
    timestamp: datetime                                    # ← datetime not str
